...
/**
 * Created by marco.compostella on 12/05/2015.
 */
public class GCMActivity extends ActionBarActivity {
    ...
    private String getRegistrationId(Context context) {
        final SharedPreferences prefs = getGcmPreferences(context);
        String registrationId = "";//prefs.getString(PROPERTY_REG_ID, ""); test
     ...
     */
    private void sendRegistrationIdToBackend(String url, String regId) {
